                ...
                <div className='col-md-6 bg-light-dark p-5 rounded'>
                    ...
                    <form onSubmit={handleRegistration}>
                        ...
                        <div className='mb-5'>
                            ...
                            <div> {success &&  <div className='alert alert-success'>Registration successful</div>}</div>
                        
                        {
                            loading?
                            (
                                <button type='submit' className='btn btn-info d-block mx-auto' disabled>Pease wait....</button>
                            ):
                            (
